...
function textInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  if(attr.name === 'tinymce') console.log('setting up tinymce textInputType');
  var composing = false;
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse',
  ...
  $scope.$watch(function ngModelWatch() {
    ...
    if (ctrl.$modelValue !== value) {
      console.log($attr.name, 'ngModelWatch model vs value', ctrl.$modelValue, 'vs', value);
      ...
      if (ctrl.$viewValue !== value) {
        console.log($attr.name, 'ngModelWatch view vs value', ctrl.$viewValue, 'vs', value);
